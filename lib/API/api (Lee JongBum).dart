...
//       .get(Uri.parse('https://172.30.1.33:45455/api/VendorSidebarModels'));
...
//   HttpOverrides.global = new MyHttpOverrides();
//   final response =
//       await http.get(Uri.parse('https://172.30.1.33:45455/api/ImageModels'));
//   List<Image1> image = [];
...
//   HttpOverrides.global = new MyHttpOverrides();
//   final response = await http.post(
//     Uri.parse('https://172.30.1.33:45455/api/VendorRegModels'),
//     headers: <String, String>{
//       'Content-Type': 'application/json; charset=UTF-8',
//     },
//     body: jsonEncode(<String, String>{
