...
import 'package:iconnexz/Chicken%20Rice/ChickenRiceMain.dart';
...
class ChickenRiceScreen extends StatelessWidget {
        ...
        body: Column(
            children: <Widget>[
              ...
              Expanded(flex: 3,
                ...
                children: [
                  ScreenTypeLayout(
                  mobile: ChickenRiceMain(),
                  desktop: ChickenRiceMain(),
                ),
                ],
               ),
              ))),
