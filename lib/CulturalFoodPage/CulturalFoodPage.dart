...
import 'package:iconnexz/CulturalFoodPage/CulturalFoodScreen.dart';
...
class CulturalFoodPage extends StatelessWidget {
  @override
            ...
            children: <Widget>[
              ...
              Expanded(flex: 3,
                child: ScreenTypeLayout(
                  mobile: CulturalFoodScreen(),
                  desktop: CulturalFoodScreen(),
                ),
              ),
               Footer(),
            ],
