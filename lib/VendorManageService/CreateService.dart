                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onPressed: () {
                                                                                if (_formKey.currentState!.validate()) {
                                                                                  setState(() {
                                                                                    uploadSelectedFile();
                                                                                    createService(_controller1.text, _controller2.text, _controller3.text, _controller4.text, int.parse(_controller5.text), _controller6.text, priceStart.text, priceEnd.text, search, isChecked.toString(), _controller10.text);
                                                                                  });
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onPressed: () {
                                                                                setState(() {
                                                                                  createServiceMapping(isChecked2.toString(), "Shahryar");
                                                                                });
...
showAlertDialog(BuildContext context) {
  ...
  AlertDialog alert = AlertDialog(
    title: Text("Congrats"),
    content: Text("Service Has Been Created!"),
    actions: [
      remindButton,
    ],
  );
...
showAlertDialog2(BuildContext context) {
  ...
  AlertDialog alert = AlertDialog(
    title: Text("Congrats"),
    content: Text("Service Variation Added!"),
    actions: [
      remindButton,
    ],
  );
